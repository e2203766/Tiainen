...
const Whyus = () => {
    ...
    return (
        ...
        <Box sx={{ bgcolor: '#87CEFA', color: 'primary.main', p: 2, mb: 2, textAlign: "center" }}>
            <Container maxWidth="xl">
                ...
                <Typography sx={{ mb: 8, fontWeight: 600 }}
                    variant='h5'
                >We bring people together and provide support and development at every stage of lifes jorney and mutal understanding through temwork and inspiration 
                </Typography>
