...
const Doctors = () => {
    ...
    const swalAlert = () => {
        ...
        return swal("Write the data here:", {
            ...
            .then((value) => {
                swal(`You information is :➥ ${value} You will get a confirmation Email soon if the slot is free. We are trying to make it automated asap. Till then be patient`);
            });
    }
    return (
        <div id='doctors'>
            {doctors[0].length !==0 ? <>
                <Box sx={{ bgcolor: '#ADD8E6', color: 'primary.main', p: 2, mb: 2, mt: 6, textAlign: "center" }}>
                    <Container maxWidth="xl">
                        <Typography sx={{ mt: 2, mb: 2, fontWeight: 600 }}
                            variant='h5'
                        >TIAINEN team always ready to assist you
                        </Typography>
                                            ...
                                            <CardActionArea>
                                                ...
                                                <CardContent sx={{ display: 'flex', mx: 'auto', my: 2 }}>
                                                    ...
                                                    <Typography gutterBottom variant="h5" component="div">
                                                        Specialist:  {doctor.specialize}
                                                    </Typography>
                                                </CardContent>
                                                <Typography gutterBottom variant="h6" component="div">
                                                    assistent: {doctor.name}
                                                </Typography>
                                            </CardActionArea>
